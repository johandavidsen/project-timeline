...
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Timeline_vue_vue_type_style_index_0_lang_scss_shadow__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("35c0");
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Timeline_vue_vue_type_style_index_0_lang_scss_shadow__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Timeline_vue_vue_type_style_index_0_lang_scss_shadow__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Timeline_vue_vue_type_style_index_0_lang_scss_shadow__WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Timeline_vue_vue_type_style_index_0_lang_scss_shadow__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Timeline_vue_vue_type_style_index_0_lang_scss_shadow__WEBPACK_IMPORTED_MODULE_0___default.a); 
...
// load the styles
var content = __webpack_require__("e5be");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add CSS to Shadow Root
var add = __webpack_require__("35d6").default
module.exports.__inject__ = function (shadowRoot) {
  add("18bf5e6c", content, shadowRoot)
};
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"77bfa261-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Timeline.vue?vue&type=template&id=597d9c82&shadow
...
return _c('div',{key:("t-" + tkey),staticClass:"year",style:({ left: yearGap + '%' })},[_c('p',{style:('margin-left:' + textMargin + ';')},[_vm._v(_vm._s(year))])])}),_vm._l((_vm.progressedTime),function(ref,pkey){
var year = ref.year;
var yearGap = ref.yearGap;
var textMargin = ref.textMargin;
return _c('div',{key:("p-" + pkey),staticClass:"progressed-year",style:({ left: yearGap + '%' })},[_c('p',{staticClass:"primary",style:('margin-left:' + textMargin + ';')},[_vm._v(_vm._s(year))])])}),_c('div',{staticClass:"progressed-time",style:({ width: _vm.time + '%' })}),_c('div',{staticClass:"airplane",style:({ width: _vm.time + '%' })},[_c('font-awesome-icon',{attrs:{"icon":"plane","size":"2x"}})],1),_vm._l((_vm.markers),function(ref,mkey){
var date = ref.date;
var marker = ref.marker;
return _c('div',{key:("m-" + mkey),staticClass:"circle",style:({ left:  marker + '%'}),attrs:{"data-date":date},on:{"click":_vm._click}})})],2)]),_c('div',{ref:"project-content",staticClass:"project-content"},[_vm._t("default")],2)])}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/Timeline.vue?vue&type=template&id=597d9c82&shadow
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Timeline.vue?vue&type=script&lang=js&shadow
...
index_es["c" /* library */].add(faPlane);
/* harmony default export */ var Timelinevue_type_script_lang_js_shadow = ({
  name: 'Timeline',
  props: ['dataStartDate', 'dataEndDate'],
    ...
    _mapMarkers(entries) {
      ...
      this.markers = f.map(entry => {
        if (entry.childNodes.length >= 1) {
          // Several items
          let subEntries = Array.from(entry.childNodes).filter(child => /DIV/.test(child.tagName));
          return {
  ...
  components: [vue_fontawesome_index_es["a" /* FontAwesomeIcon */]]
});
// CONCATENATED MODULE: ./src/components/Timeline.vue?vue&type=script&lang=js&shadow
 /* harmony default export */ var components_Timelinevue_type_script_lang_js_shadow = (Timelinevue_type_script_lang_js_shadow); 
...
function injectStyles (context) {
  ...
  var style0 = __webpack_require__("3522")
...
/* harmony default export */ var Timelineshadow = (component.exports);
...
window.customElements.define('project-timeline', vue_wc_wrapper(external_Vue_default.a, Timelineshadow))
...
// Module
exports.push([module.i, ".primary{color:#00adef}.none,.project-gallery{display:none}.project-timeline{height:50px;padding:10px 0}.project-content{display:none}.line-cont{width:100%;height:20%}.line{height:2px;width:100%;background:#adb5bd;margin:auto;top:50%;transform:translateY(-50%);position:relative}.year{background:#adb5bd}.progressed-year,.year{height:15px;width:2px;position:absolute;padding-top:15px}.progressed-time,.progressed-year{background:#00adef}.progressed-time{height:2px;margin:auto;top:50%;transform:translateY(-50%);position:absolute}.circle{width:15px;height:15px;background:#fff;border-radius:15px;position:absolute;top:-9px;border:2px solid #00adef;cursor:pointer;z-index:1}.circle:before{content:\"\";width:7px;height:7px;background:#00adef;position:absolute;border-radius:100%;top:2px;left:2px;display:none}.circle.active .popupSpan,.circle.active:before,.circle.hover .popupSpan,.circle.hover:before{display:block}.circle.active .popupSpan{top:-40px}.airplane{position:absolute;top:-15px;left:56%}", ""]);
// Exports
